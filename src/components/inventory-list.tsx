...
import { InventoryForm, type ItemFormValues } from '@/components/inventory-form';
import {
  Dialog,
  DialogContent,
  DialogHeader,
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-zinc-800 hover:bg-transparent">
                  ...
                  <TableHead className="text-zinc-400">Current Location</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {items.map((item) => (
                  ...
                  >
                    ...
                    <TableCell className="text-zinc-400">{item.serial_number || '-'}</TableCell>
                    <TableCell>
                      {item.condition_enum ? (
                        <Badge
                          variant="outline"
                    ...
                    <TableCell className="text-zinc-400">{item.current_location || '-'}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
