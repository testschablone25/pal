  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-white">
                  <Badge variant="outline" className="border-zinc-700 text-zinc-300 mt-1">
              ...
              <div>
                <label className="text-sm text-zinc-500">Current Location</label>
            ...
            <div className="space-y-4">
                ...
                <p className="mt-1">
                  {item.condition_enum ? (
                    <Badge
                      ...
                      className={cn(
                        "capitalize",
                        conditionConfig[item.condition_enum] || 'bg-zinc-600/20 text-zinc-400 border-zinc-600/50'
                      )}
                    >
                      {item.condition_enum}
                    </Badge>
              ...
              {item.condition_notes && (
                <div>
                  <label className="text-sm text-zinc-500">Condition Notes</label>
                  <p className="text-zinc-300 text-sm mt-1">{item.condition_notes}</p>
                </div>
              )}
              {item.notes && (
                <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-white text-sm mt-1">{formatDate(item.created_at)}</p>
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-white">{formatDate(item.active_rental.start_date)}</p>
              </div>
              <div>
                <label className="text-sm text-zinc-500">Expected Return</label>
                <p className="text-white">{formatDate(item.active_rental.expected_return_date)}</p>
              </div>
            </div>
            <Button
      ...
      <Card className="bg-zinc-900 border-zinc-800">
        ...
        <CardContent>
          {history.length === 0 ? (
            <p className="text-zinc-500 text-center py-6">No location history recorded</p>
          ) : (
            <div className="space-y-4">
