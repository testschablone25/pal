...
export const ROLE_CONFIG: Record<
	AppRole,
	{ label: string; badgeColor: string; rank: number; description: string }
> = {
	admin: {
		label: "Admin",
	...
	manager: {
		...
		rank: 90,
		description: "Geschäftsführung und operative Leitung",
	},
	"tech-lead": {
		label: "Tech Lead",
		badgeColor: "bg-purple-600",
		rank: 85,
		description: "Technische Leitung",
	},
	booking: {
		label: "Booking",
		badgeColor: "bg-amber-600",
		rank: 80,
		description: "Künstler- und Eventbuchung",
	},
	"social-media": {
		label: "Social Media",
		badgeColor: "bg-pink-600",
		rank: 75,
		description: "Marketing und Social Media",
	},
	"night-management": {
		label: "Night Management",
		badgeColor: "bg-indigo-600",
		rank: 70,
		description: "Nächtliche Veranstaltungsleitung",
	},
	backoffice: {
		label: "Backoffice",
		badgeColor: "bg-teal-600",
		rank: 65,
		description: "Verwaltung und Personalwesen",
	},
	label: {
		label: "Label",
		badgeColor: "bg-violet-600",
		rank: 60,
		description: "Label- und Musikmanagement",
	},
	tech: {
		label: "Tech",
		badgeColor: "bg-blue-600",
		rank: 50,
		description: "Technik und Equipment",
	},
	staff: {
		label: "Staff",
		badgeColor: "bg-cyan-600",
		rank: 40,
		description: "Allgemeines Personal",
	},
	gastro: {
		label: "Gastro",
		badgeColor: "bg-orange-600",
		rank: 35,
		description: "Gastronomie und Bar",
	},
	awareness: {
		label: "Awareness",
		badgeColor: "bg-emerald-600",
		rank: 30,
		description: "Awareness und Sicherheit",
	},
	azubi: {
		label: "Azubi",
...
export function canAccessRoute(
	userRoles: AppRole[] | AppRole | null,
	pathname: string,
): boolean {
	// No roles = no access
...
export function getRoleBadges(
	roles: AppRole[],
): Array<{ role: AppRole; label: string; color: string }> {
...
export function parseRoles(roles: unknown): AppRole[] {
	...
	return roles.filter(
		(r): r is AppRole => typeof r === "string" && isValidRole(r),
	);
}
